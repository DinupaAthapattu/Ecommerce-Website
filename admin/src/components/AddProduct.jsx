  ...
  return (
    <div className='p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7'>
      ...
      <div className="mb-3 flex items-center gap-x-4">
        <h4 value={productDetails.category} onChange={changeHandler} className="bold-18 pb-2s">Product Category</h4>
        <select name='category'  value={productDetails.category} onChange={changeHandler} id='' className='bg-primary ring-1 ring-slate-900/20 medium-16 rounded-sm outline-none'>
